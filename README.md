...
curl https://getbootstrap.com/docs/5.2/assets/img/favicons/favicon-16x16.png --create-dirs -o docs/5.2/assets/img/favicons/favicon-16x16.png 
curl https://getbootstrap.com/docs/5.2/assets/img/favicons/favicon.ico --create-dirs -o docs/5.2/assets/img/favicons/favicon.ico 
curl https://getbootstrap.com/docs/5.2/assets/img/favicons/android-chrome-192x192.png --create-dirs -o docs/5.2/assets/img/favicons/android-chrome-192x192.png 
curl https://getbootstrap.com/docs/5.2/assets/img/favicons/manifest.json --create-dirs -o docs/5.2/assets/img/favicons/manifest.json 
curl https://getbootstrap.com/docs/5.2/assets/img/favicons/safari-pinned-tab.svg --create-dirs -o docs/5.2/assets/img/favicons/safari-pinned-tab.svg 
